...
// Idea determinista para una fecha 'YYYY-MM-DD' (misma fecha → misma idea
// para cualquiera que la consulte ese día, sin IA ni base de datos).
export function getIdeaForDate(dateKey) {
...
// de contenido (POST /api/admin/marketing-playbook/generate) a las
