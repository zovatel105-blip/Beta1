...
export const CONTENT_PILLARS = [
  {
    ...
    label: 'AI Transformation Reveal',
    angle: 'Muestra el editor de IA de Luxury Battle transformando una selfie normal en una escena de lujo (yate, jet privado, alfombra roja, etc.) — hook: mostrar el RESULTADO final primero, luego "rebobinar" a cómo se hizo, terminar con el botón "Save to device" y el resultado subido a la Luxury Battle.',
  },
  {
    key: 'versus_battle',
    label: 'Versus Battle Hype',
    angle: 'Muestra a alguien subiendo una publicación "versus" (2 vídeos, opción A/B) y a la comunidad votando deslizando y tocando dos veces — hook tipo "¿cuál elegirías tú?", terminar mostrando el contador de votos subiendo en tiempo real.',
  },
  {
    key: 'duet_challenge',
    label: '1v1 Duet Challenge',
    angle: 'Muestra a alguien retando a un amigo a un "Duet" 1vs1 (pantalla dividida, cada uno con su clip) — hook tipo "reté a mi mejor amigo a esto", terminar con el ganador anunciado y la reacción de ambos.',
  },
  {
    key: 'testimonial_pov',
    label: 'POV Reaction',
    angle: 'Formato POV/reacción relatable y con humor ligero, ej. "POV: descubres que puedes verte como millonario gratis" — más cercano y menos "publicitario", terminando en descargar/abrir la app.',
  },
  {
    key: 'educational_hook',
    label: 'Did You Know (listicle)',
    angle: 'Formato educativo rápido tipo "3 cosas que Twyk puede hacer y no sabías" — 3 demos cortas encadenadas (Luxury Battle, Duet, Retos) en menos de 30s, ritmo rápido con cortes.',
  },
]
