...
export const AI_STYLE_PRESETS = [
  ...
  // flexeando dinero en un rolls royce") — 6 estilos más de "cars": los 2
  // pedidos explícitamente (interior de Maybach, flex de dinero en Rolls
  // Royce — distinto del ya existente `rolls-royce-cash`, que muestra el
  // interior con el dinero en el asiento; este nuevo se centra en el
  // GESTO de flexear un fajo de billetes en primer plano) + 4 más
  // (Ferrari, Bugatti, Bentley, G-Wagon) para seguir ampliando la
  // categoría. Imágenes reales vía crawl_tool sobre páginas de búsqueda de
  // Pexels (los 2 usos permitidos de vision_expert_agent ya se agotaron en
  // esta sesión), cada URL verificada con fetch real (200 OK) antes de
  // incluirla.
  {
    id: 'maybach-interior',
    label: 'Maybach Interior',
    category: 'cars',
    thumb: 'https://images.pexels.com/photos/26691305/pexels-photo-26691305.jpeg?auto=compress&cs=tinysrgb&w=480&h=480',
    promptHint: 'Put me sitting inside the plush leather interior of a Maybach, premium wood trim and ambient lighting, elegant outfit, photorealistic.',
  },
  {
    id: 'rolls-royce-money-flex',
    label: 'Rolls Royce Money Flex',
    category: 'cars',
    thumb: 'https://images.pexels.com/photos/4968655/pexels-photo-4968655.jpeg?auto=compress&cs=tinysrgb&w=480&h=480',
    promptHint: 'Put me inside a Rolls-Royce flexing a fanned stack of cash close to the camera, confident expression, luxurious leather interior, photorealistic.',
  },
  {
    id: 'ferrari-open-road',
    label: 'Ferrari Open Road',
    category: 'cars',
    thumb: 'https://images.pexels.com/photos/12964218/pexels-photo-12964218.jpeg?auto=compress&cs=tinysrgb&w=480&h=480',
    promptHint: 'Put me driving a red Ferrari on an open road, confident pose, sunny day, photorealistic.',
  },
  {
    id: 'bugatti-showroom',
    label: 'Bugatti Showroom',
    category: 'cars',
    thumb: 'https://images.pexels.com/photos/12964186/pexels-photo-12964186.jpeg?auto=compress&cs=tinysrgb&w=480&h=480',
    promptHint: 'Put me posing next to a Bugatti in a sleek glass-walled showroom, dramatic lighting, photorealistic.',
  },
  {
    id: 'bentley-arrival',
    label: 'Bentley Arrival',
    category: 'cars',
    thumb: 'https://images.pexels.com/photos/8343503/pexels-photo-8343503.jpeg?auto=compress&cs=tinysrgb&w=480&h=480',
    promptHint: 'Put me standing next to a sleek black Bentley parked on an elegant urban street, confident pose, photorealistic.',
  },
  {
    id: 'g-wagon-urban-night',
    label: 'G-Wagon Urban Night',
    category: 'cars',
    thumb: 'https://images.pexels.com/photos/20136034/pexels-photo-20136034.jpeg?auto=compress&cs=tinysrgb&w=480&h=480',
    promptHint: 'Put me standing next to a black Mercedes G-Wagon parked on a vibrant city street at night, neon lights, photorealistic.',
  },
]
